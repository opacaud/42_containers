...
/*   Updated: 2022/03/23 13:19:57 by opacaud          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_stack_list_mine(ft::stack< int, std::list<int> > stack)
{	
	if (stack.empty())
		return ;
...
void	print_vector_int_mine(ft::vector<int> vec)
{
...
void	print_vector_str_mine(ft::vector<std::string> vec)
{
    ft::vector<std::string>::iterator begin;
    ft::vector<std::string>::iterator end;
...
void	print_map_int_str_mine(ft::map<int, std::string> & map)
{
...
int main()
{
...

	{
		...
		std::cout << "ft::vector<int> vec1;" << RESET << std::endl << std::endl;
		ft::vector<int> vec1;
		...
		std::cout << "ft::vector<int> vec2(100, 42);" << RESET << std::endl << std::endl;
		...
		std::cout << "ft::vector<int> vec3(vec2.begin(), vec2.end() - 92);" << RESET << std::endl << std::endl;
		ft::vector<int> vec3(vec2.begin(), vec2.end() - 92);
		...
		std::cout << "ft::vector<int> vec4(vec2);" << RESET << std::endl << std::endl;
		...
		std::cout << "ft::vector<int> vec5 = vec3;" << RESET << std::endl << std::endl;
		ft::vector<int> vec5 = vec3;
		...
		std::cout << YELLOW << "fill constructor - Vector.hpp - line 69" << RESET << std::endl;
		std::cout << "ft::vector<int> vec6(1000000);" << RESET << std::endl << std::endl;
		ft::vector<int> vec6(1000000);
...

	{
    	...
    	std::cout << BOLDGREEN   << std::endl << "---------- vec1 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "default constructor - Vector.hpp - line 62" << RESET << std::endl;
		std::cout << "ft::vector<std::string> vec1;" << RESET << std::endl << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec2 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "fill constructor - Vector.hpp - line 69" << RESET << std::endl;
		std::cout << "ft::vector<std::string> vec2(100, \"Forty-two!\");" << RESET << std::endl << std::endl;
		ft::vector<std::string> vec2(100, "Forty-two!");
		std::cout << "capacity(): " << vec2.capacity() << std::endl;
		std::cout << "size(): " << vec2.size() << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec3 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "range constructor - Vector.hpp - line 86" << RESET << std::endl;
		std::cout << "ft::vector<std::string> vec3(vec2.begin(), vec2.end() - 92);" << RESET << std::endl << std::endl;
		ft::vector<std::string> vec3(vec2.begin(), vec2.end() - 92);
		std::cout << "capacity(): " << vec3.capacity() << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec4 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "copy constructor - Vector.hpp - line 114" << RESET << std::endl;
		std::cout << "ft::vector<std::string> vec4(vec2);" << RESET << std::endl << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec5 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "operator= - Vector.hpp - line 138" << RESET << std::endl;
		std::cout << "ft::vector<std::string> vec5 = vec3;" << RESET << std::endl << std::endl;
		ft::vector<std::string> vec5 = vec3;
		std::cout << "vec3.capacity(): " << vec3.capacity() << std::endl;
		std::cout << "vec3.size(): " << vec3.size() << std::endl;
		std::cout << "vec5.capacity(): " << vec5.capacity() << std::endl;
		std::cout << "vec5.size(): " << vec5.size() << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec6 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "fill constructor - Vector.hpp - line 69" << RESET << std::endl;
		std::cout << "ft::vector<std::string> vec6(1000000);" << RESET << std::endl << std::endl;
		ft::vector<std::string> vec6(1000000);
		std::cout << "capacity(): " << vec6.capacity() << std::endl;
		std::cout << "size(): " << vec6.size() << std::endl;
...

	{
		...
		std::cout << "ft::stack<int> stk1;" << RESET << std::endl << std::endl;
		ft::stack<int> stk1;
		...
		std::cout << "ft::stack<int> stk2 = stk1;" << RESET << std::endl << std::endl;
		...
		std::cout << "ft::stack<int> stk3(stk2);" << RESET << std::endl << std::endl;
...

	{
		...
		std::cout << YELLOW << "default constructor - Stack.hpp - line 42" << RESET << std::endl;
		std::cout << "ft::stack< int, std::list<int> > stk_lst1;" << RESET << std::endl << std::endl;
		ft::stack< int, std::list<int> > stk_lst1;
		...
		std::cout << YELLOW << "operator= - Stack.hpp - line 53" << RESET << std::endl;
		std::cout << "ft::stack< int, std::list<int> > stk_lst2 = stk_lst1;" << RESET << std::endl << std::endl;
		ft::stack< int, std::list<int> > stk_lst2 = stk_lst1;
		...
		std::cout << BOLDGREEN   << std::endl << "------ stk3 && stk2 ------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "copy constructor - Stack.hpp - line 48" << RESET << std::endl;
		std::cout << "ft::stack< int, std::list<int> > stk_lst3(stk_lst2);" << RESET << std::endl << std::endl;
		ft::stack< int, std::list<int> > stk_lst3(stk_lst2);
...

	{
		...
		std::cout << "ft::pair<int, int> p1(42, 41);" << RESET << std::endl << std::endl;
		ft::pair<int, int> p1(42, 41);
		...
		std::cout << "ft::pair<int, int> p2(43, 40);" << RESET << std::endl << std::endl;
		std::cout << "(p1 > p2)" << RESET << std::endl << std::endl;
		ft::pair<int, int> p2(43, 40);
		std::cout << "p1.first: " << p1.first << " - p1.second: " << p1.second << std::endl;
...

	{
		...
		std::cout << BOLDGREEN   << std::endl << "----------- p1 -----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "initialization constructor - Pair.hpp - line 50" << RESET << std::endl;
		std::cout << "ft::pair<int, std::string> p1(42, \"Quarante-deux!\");" << RESET << std::endl << std::endl;
		ft::pair<int, std::string> p1(42, "Quarante-deux!");
		std::cout << "p1.first: " << p1.first << " - p1.second: " << p1.second << std::endl;

		std::cout << BOLDGREEN   << std::endl << "-------- p2 && p1 --------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "operator> - Pair.hpp - line 97" << RESET << std::endl;
		std::cout << "ft::pair<int, std::string> p2(43, \"Quarante!\");" << RESET << std::endl << std::endl;
		std::cout << "(p1 > p2)" << RESET << std::endl << std::endl;
		ft::pair<int, std::string> p2(43, "Quarante!");
		std::cout << "p1.first: " << p1.first << " - p1.second: " << p1.second << std::endl;
		std::cout << "p2.first: " << p2.first << " - p2.second: " << p2.second << std::endl;
		std::cout << "(p1 > p2): " << (p1 > p2) << std::endl;
...

	{
		...
		std::cout << "ft::map<int, std::string> map1;" << RESET << std::endl << std::endl;
		...
		std::cout << "ft::pair<int, std::string> pair_one = ft::make_pair(65, \"A\");" << RESET << std::endl;
		std::cout << "ft::pair<int, std::string> pair_two = ft::make_pair(66, \"B\");" << RESET << std::endl;
		std::cout << "ft::pair<int, std::string> pair_three = ft::make_pair(67, \"C\");" << RESET << std::endl;
		// std::cout << "ft::pair<int, std::string> pair_four = ft::make_pair(68, \"D\");" << RESET << std::endl;
		// std::cout << "ft::pair<int, std::string> pair_five = ft::make_pair(69, \"E\");" << RESET << std::endl;
		...
		// ft::pair<int, std::string> pair_four = ft::make_pair(68, "D");
		// ft::pair<int, std::string> pair_five = ft::make_pair(69, "E");
		...
		std::cout << "ft::map<int, std::string> map2(map1.begin(), map1.end());" << RESET << std::endl << std::endl;
		...
		std::cout << "ft::map<int, std::string> map3;" << RESET << std::endl;
		...
		std::cout << "ft::map<int, std::string> map4(map2);" << RESET << std::endl << std::endl;
		...
		std::cout << "ft::map<int, std::string> map5 = map4;" << RESET << std::endl << std::endl;
		ft::map<int, std::string> map5 = map4;
		...
		ft::map<int, std::string>::iterator it = map5.find(6600);
		if (it != map5.end())
...
void    print_vector_mine(ft::random_access_iterator<int> begin, ft::random_access_iterator<int> end)
{
    while (begin != end)
    {
        std::cout << *begin << std::endl;
...
int main()
{

	{
		...
		ft::vector<int>	vec2(4, 6);

		print_vector_mine(vec2.begin(), vec2.end());
		vec2.pop_back();
		std::cout << std::endl;
		print_vector_mine(vec2.begin(), vec2.end());
		std::cout << std::endl;
...

	{
		...
		ft::vector<int> vec3(3, 42);
		ft::vector<int> vec4(3, 84);

		print_vector_mine(vec3.begin(), vec3.end());
		print_vector_mine(vec4.begin(), vec4.end());
...

	{
		...
		ft::vector<int> vec2(2, 42);
		ft::vector<int> vec2_to_add(3, 84);
		ft::vector<int> vec2_to_add2(1, 8);
...

	{
		...
		// ft::vector<int> vec_vrai;
		// ft::vector<int> vec_vrai(2);
		ft::vector<int> vec_vrai(4, 46);

		ft::vector<int> vec_to_add2(2, 78);
